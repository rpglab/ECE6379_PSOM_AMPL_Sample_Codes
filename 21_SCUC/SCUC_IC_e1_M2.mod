# SCUC example
# by Xingpeng.Li
# run command: include fileName.mod; e.g. include SCUC_IC_e1_M2.mod;
...
subject to genRRLimit_Up {g in GEN, t in PERIOD: t>1}: Pg[g,t] - Pg[g,t-1] <= gen_RRlimit[g]*u[g,t-1] + BigM*v[g,t];  # assume infinite startup ramping rate
subject to genRRLimit_Dn {g in GEN, t in PERIOD: t>1}: Pg[g,t-1] - Pg[g,t] <= gen_RRlimit[g]*u[g,t] + BigM*(v[g,t]-u[g,t]+u[g,t-1]); # assume infinite shutdown ramping rate
