# SCUC example
# by Xingpeng.Li
# run command: include fileName.mod; e.g. include SCUC_IC_e1.mod;
...
subject to genRRLimit_1_H2_Up: Pg1_H2 - Pg1_H1 <= RR1*u1_H1 + BigM*v1_H2;  # assume infinite startup ramping rate
subject to genRRLimit_1_H2_Dn: Pg1_H1 - Pg1_H2 <= RR1*u1_H2 + BigM*(v1_H2-u1_H2+u1_H1);  # assume infinite shutdown ramping rate
...
subject to genRRLimit_2_H2_Up: Pg2_H2 - Pg2_H1 <= RR2*u2_H1 + BigM*v2_H2;  # assume infinite startup ramping rate
subject to genRRLimit_2_H2_Dn: Pg2_H1 - Pg2_H2 <= RR2*u2_H2 + BigM*(v2_H2-u2_H2+u2_H1);  # assume infinite shutdown ramping rate
