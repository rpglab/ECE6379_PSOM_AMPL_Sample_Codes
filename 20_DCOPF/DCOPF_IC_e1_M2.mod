# DCOPF example 
# by Xingpeng.Li
# run command: include fileName.mod; e.g. include DCOPF_IC_e1_M2.mod;
...
subject to lineFlowEqs{k in BRANCH}: pk[k]/BaseMW = (theta[branch_frmbus[k]] - theta[branch_tobus[k]])/branch_x[k];
