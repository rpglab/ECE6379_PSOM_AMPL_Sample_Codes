# LMP example 
# by Xingpeng.Li
# run command: include fileName.mod; e.g. include LMP_IC_e4.mod;
...
param Load1 = 0;
param Load2 = 6;  # to verify the LMP at bus 2 of this example, you can simply increase this load value by 1; then, compare the total cost change
param Load3 = 95;  # to verify the LMP at bus 3 of this example, you can simply change this load value by 1; then, compare the total cost change

param x; let x := 0.1;
param branchRate1; let branchRate1 := 100;
param branchRate2; let branchRate2 := 100;
param branchRate3; let branchRate3 := 30;
...
subject to lineFlow_2: pk2/BaseMW = (theta1 - theta3)/(3*x);
subject to lineFlow_3: pk3/BaseMW = (theta2 - theta3)/(x);

subject to PowerBalance_1: G1 - pk1 - pk2 = Load1;
subject to PowerBalance_2: pk1 - pk3 = Load2;
subject to PowerBalance_3: G3 + pk2 + pk3 = Load3;
